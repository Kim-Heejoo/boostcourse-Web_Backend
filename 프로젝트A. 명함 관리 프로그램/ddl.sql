...
--
-- Table structure for table `cardmanager`
--

DROP TABLE IF EXISTS `cardmanager`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `cardmanager` (
  ...
  `createDate` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  PRIMARY KEY (`cardno`)
...
-- Dump completed on 2020-08-04  2:43:36
